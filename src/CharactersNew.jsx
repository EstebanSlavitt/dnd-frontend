...
export function CharactersNew({ onCreate }) {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: 'url("https://cdn.pixabay.com/photo/2022/12/30/10/52/mountain-7686642_1280.jpg")' }}
    >
      <div className="max-w-3xl mx-auto p-10 bg-gray-800 bg-opacity-90 rounded-lg shadow-lg">
